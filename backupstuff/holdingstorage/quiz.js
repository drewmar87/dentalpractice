let questions = [
  ...
  },
  {
    ...
    answers: ["Airborne transmission", 
              "Direct transmission", 
              "Indirect transmission", 
              "Spatter transmission"],
    correct: 2,
    difficulty: 2,
    category: "Infection Control",
  ...
  },
  {
    ...
    answers: ["A chemically treated tape used on packages that changes color", 
              "The time, temperature, and pressure used", 
              "A biological spore test through a monitoring system", 
              "Autoclave bags"],
    correct: 2,
    difficulty: 3,
    category: "Infection Control",
  ...
  },
  {
    ...
    answers: ["All infectious waste destined for disposal should be placed in closable, leak-proof containers or bags that are color coded or labeled appropriately.", 
              "Infectious waste should be burned in a local incinerator.", 
              "Only the clinical assistant should manage the removal of infectious waste.", 
              "Only the office manager should manage the removal of infectious waste."],
    correct: 0,
    difficulty: 1,
    category: "Infection Control",
  ...
  },
  {
    ...
    answers: ["Overgloves are worn when an assistant has an allergy to latex.", 
              "Overgloves are placed before the secondary procedure is performed and are removed before patient treatment is resumed.", 
              "Overgloves are made of latex.", 
  ...
  },
  {
    ...
    answers: ["Placement of a composite", 
              "Oral surgery", 
